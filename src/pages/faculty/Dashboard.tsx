...
export default function Dashboard() {
  return (
    <PageTransition>
      <SectionHeader title="Faculty Dashboard" subtitle="Your projects, students, and milestones" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Faculty Dashboard — Full implementation in progress</span>
        </div>
