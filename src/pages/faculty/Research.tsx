...
export default function Research() {
  return (
    <PageTransition>
      <SectionHeader title="Research Entries" subtitle="Field research conducted by your team" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Research Entries — Full implementation in progress</span>
        </div>
