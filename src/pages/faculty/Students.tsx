...
export default function Students() {
  return (
    <PageTransition>
      <SectionHeader title="Students" subtitle="Team members across your projects" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Students — Full implementation in progress</span>
        </div>
