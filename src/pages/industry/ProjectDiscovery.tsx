...
export default function ProjectDiscovery() {
  return (
    <PageTransition>
      <SectionHeader title="Discover Projects" subtitle="Browse university projects seeking industry support" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Discover Projects — Full implementation in progress</span>
        </div>
