...
export default function Workspace() {
  return (
    <PageTransition>
      <SectionHeader title="Collaboration Workspace" subtitle="Shared workspace with university teams" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Collaboration Workspace — Full implementation in progress</span>
        </div>
