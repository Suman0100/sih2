...
export default function Feedback() {
  return (
    <PageTransition>
      <SectionHeader title="Feedback" subtitle="Feedback on your work and project" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Feedback — Full implementation in progress</span>
        </div>
