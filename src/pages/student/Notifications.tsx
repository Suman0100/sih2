...
export default function Notifications() {
  return (
    <PageTransition>
      <SectionHeader title="Notifications" subtitle="Your recent updates" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Notifications — Full implementation in progress</span>
        </div>
