...
export default function Team() {
  return (
    <PageTransition>
      <SectionHeader title="My Team" subtitle="Team AquaGuard — 4 members" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">My Team — Full implementation in progress</span>
        </div>
