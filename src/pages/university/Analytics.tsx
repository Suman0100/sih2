...
export default function Analytics() {
  return (
    <PageTransition>
      <SectionHeader title="University Analytics" subtitle="Research output and project impact" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">University Analytics — Full implementation in progress</span>
        </div>
