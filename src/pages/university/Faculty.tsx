...
export default function Faculty() {
  return (
    <PageTransition>
      <SectionHeader title="Faculty" subtitle="Faculty mentors at your institution" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Faculty — Full implementation in progress</span>
        </div>
