...
export default function Projects() {
  return (
    <PageTransition>
      <SectionHeader title="Projects" subtitle="All active and completed projects" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Projects — Full implementation in progress</span>
        </div>
