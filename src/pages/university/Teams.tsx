...
export default function Teams() {
  return (
    <PageTransition>
      <SectionHeader title="Teams" subtitle="Student teams for active projects" />
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-3">
          <Construction size={20} className="text-warning-500" />
          <span className="text-sm font-medium text-surface-700">Teams — Full implementation in progress</span>
        </div>
